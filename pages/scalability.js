...
import * as graphic2 from '../static/modules/module3.json'
import * as graphic3 from '../static/modules/module5.json'

import '../styles/content-page.scss'

export default () => {
    const prev = Content[0]
    const page = Content[1]
    const next = Content[2]
        ...
        <Layout>
            ...
            <div className="content">
                <div className="_markdown_">
                    ...
                    <Lottie 
                        options={{ ...options, animationData: graphic2.default }}
                    />
                    ...
                    <Lottie 
                        options={{ ...options, animationData: graphic3.default }}
                    />
            ...
            <Tooltip tooltipId='blockchain_bottleneck' />
            <Tooltip tooltipId='transaction' />
            <Tooltip tooltipId='consensus' />
            <Tooltip tooltipId='nakamoto_consensus' />
            <Tooltip tooltipId='proof_of_work' />
            <Tooltip tooltipId='milestones' />
