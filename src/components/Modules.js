    ...
    return (
        <div className="modules-wrapper">
            ...
            <div className="module">
                ...
                <Link to="/module1" className="btn mini">
                    Details
                </Link>
            </div>
            <div className="module">
                ...
                <Link to="/module2" className="btn mini">
                    Details
                </Link>
            </div>
            <div className="module">
                ...
                <Link to="/module3" className="btn mini">
                    Details
                </Link>
            </div>
            <div className="module">
                ...
                <Link to="/module4" className="btn mini">
                    Details
                </Link>
            </div>
            <div className="module">
                ...
                <Link to="/module5" className="btn mini">
                    Details
                </Link>
            </div>
        </div>
